...
function getUserCookie() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield axios.get(url, { withCredentials: true });
        }
        catch (err) {
...
function sendUserScrollDepth() {
    ...
    const scrolledPercent = Math.floor(((scrollTop + windowHeight) / fullHeight) * 100);
...
function sendUserInfo() {
    return __awaiter(this, void 0, void 0, function* () {
        const country = yield getUserCountry();
        const data = {
            country,
